...
class DebugChecklist {
    ...
    createResults() {
        return this.createChecks().map((check) => {
    ...
    createBossScalingCheck() {
        return {
            name:
                'Boss-Skalierung und Aggressivität aktiv',
            test: () =>
                this.hasConfiguredBossScaling()
        };
    }

    /** Returns whether both bosses use expected scaling. */
    hasConfiguredBossScaling() {
        ...
        return levelOneBoss.width ===
                GAME_CONFIG.endbossWidth * 1.4 &&
            levelTwoBoss.aggression >
                levelOneBoss.aggression;
    }
    ...
    createBackgroundLayerCheck() {
        return {
            ...
            test: () =>
                this.hasCompleteBackgroundLayers()
        };
    }
